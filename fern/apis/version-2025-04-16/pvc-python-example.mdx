...
-----
1. Create a dataset.
2. Upload audio files to the dataset.
...
def list_voices(ft_id: str) -> list[dict]:
    """GET /fine-tunes/{id}/checkpoints → list of voices."""
...
if __name__ == "__main__":
    ...
    confirmation = input("Are you sure you want to start the fine-tune? It will cost 1M credits upon successful completion (yes/no): ")
    ...
    print(f"Fine-tune {FINE_TUNE_ID} completed!")
