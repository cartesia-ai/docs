---
title: Professional Voice Cloning (Beta)
...
Professional Voice Cloning is available in the [playground](https://play.cartesia.ai) for select scale and enterprise tier users. It allows you to create highly accurate voice clones by leveraging a larger amount of data compared to instant cloning. Contact support@cartesia.ai to enable it for your account.
...
<Steps>
    ...
    We recommend uploading a minimum of 30 minutes of audio, but around 2 hours of audio is ideal. The professional voice clone will closely match your uploaded data, so make sure it sounds the way you like in terms of background noise, loudness, and speech quality.
    ...
    Professional voice clones use a model fine-tuned on your data. This will use the latest model version available in production, but will not be updated to use newer model versions. To update model versions, please train another professional voice clone.
