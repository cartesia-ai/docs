...
<Steps>
    ...
    Then, upload all of the audio files you want to use for training using the `Upload samples` button or by dragging them onto the designated area. You can upload multiple files at once. Files must be have one of the following audio formats:
