          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <a 
                ...
                onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => (e.target as HTMLElement).style.backgroundColor = isDark ? 'rgba(96, 165, 250, 0.1)' : 'rgba(59, 130, 246, 0.1)'}
                onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) => (e.target as HTMLElement).style.backgroundColor = 'transparent'}
              >
