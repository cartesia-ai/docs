...
Multi-agent systems enable specialized agents to work together by processing
events in parallel and communicating through custom events and agent handoffs.

## Pattern Overview

This pattern involves:

- **Speaking Agent**: Only one agent can send voice responses to the user at a
  time
...
1. **Custom Events**: Define typed events for inter-agent communication
1. **Background Processing**: Use non-speaking agents for analysis and insights
1. **Contextual Handoffs**: Transfer agents based on conversation context
1. **Authorization Management**: Only one agent should speak at a time

## Common Use Cases

- **Sales with Research**: Sales agent with background lead analysis and
  research
...
This pattern enables sophisticated agent coordination while maintaining clear
