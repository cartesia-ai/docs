...
Sonic-2 is the new and improved version of Sonic, with a whole new set of capabilities around generative speech.
...
- [Infill](/definition/infill) support

| Snapshot | Release Date | Languages | Status |
|----------|--------------|-----------|--------|
| <span style="color: green;">●</span>`sonic-2-2025-03-07` | March 7, 2025 | en, fr, de, es, pt, zh, ja, hi, it, ko, nl, pl, ru, sv, tr | Stable |
