...
| ------------------------------------------------------- | ----------------- | ---------------------------------------------------------- | ------ |
| <span style="color: green;">●</span> `ink-whisper` | June 10, 2025 | `en`, `de`, `es`, `fr`, `ja`, `pt`, `zh`, `hi`, `it`, `ko`, `nl`, `pl`, `ru`, `sv`, `tr` | Stable |
| `ink-whisper-2025-06-04` | June 4, 2025 | `en`, `de`, `es`, `fr`, `ja`, `pt`, `zh`, `hi`, `it`, `ko`, `nl`, `pl`, `ru`, `sv`, `tr` | Stable |
