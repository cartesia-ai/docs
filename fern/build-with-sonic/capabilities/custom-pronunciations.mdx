...
<Note>
The Sonic model, along with the dated versions (e.g. `sonic-2024-12-12`) uses Sonic-flavored IPA phonemes for English. For languages other than English as well as for the Sonic Preview model, we uses MFA-style IPA. We will soon be updating all models to use MFA-style IPA.
</Note>
