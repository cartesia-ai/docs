...
Learn more about available Sonic model variants and their capabilities in the [TTS Models](/build-with-cartesia/model/models-tts) section.
...
Learn more about the Ink model and its capabilities in the [STT Models](/build-with-cartesia/models/models-stt) section.
