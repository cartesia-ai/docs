...
2. Member: can use all functionality included in the subscription, but cannot alter the organization settings.
...
Once you create and upgrade an organization, you can create voices, Line agents, API keys, and more in the organization. They will be available to all users in the organization. The only exceptions are playground generation history and starred voices, which are per-user in the organization.

</Steps>

### Create additional organizations

If you want to separate different workspaces on different subscriptions, you can create another organization by going to the playground at [https://play.cartesia.ai](https://play.cartesia.ai), selecting the workspace switcher, and clicking **Create organization**.
...
Please reach out to us at support@cartesia.ai if you run into any troubles with your organization subscription.
