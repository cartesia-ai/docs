...
slug: concepts/embeddings-and-voice-mixing
---

<Note>
You don't need to understand embeddings to use Voice Mixing. Visit the [Voice Mixing](/build-with-sonic/capabilities/voice-mixing) guide to get started.
</Note>
