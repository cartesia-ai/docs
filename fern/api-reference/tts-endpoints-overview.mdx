...
We offer three different text-to-speech endpoints depending on your needs.
...
We recommend using our raw bytes (i.e. audio file) output endpoint, which can give you outputs in a variety of formats, such as WAV and MP3.
