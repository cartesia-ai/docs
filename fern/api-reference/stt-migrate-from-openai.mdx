...
**OpenAI Compatible:** `/audio/transcriptions` - Drop-in replacement for OpenAI Whisper

## Migration Guide

Replace your OpenAI base URL with Cartesia's endpoint to use the `/audio/transcriptions` compatibility layer.
