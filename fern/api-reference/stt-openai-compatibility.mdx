...
<Info>
**Batch STT Only**: This documentation covers OpenAI SDK compatibility for Cartesia's Batch Speech-to-Text transcription. For real-time transcription, use our [Streaming STT endpoint](/api-reference/stt/channel) which doesn't have OpenAI SDK compatibility.
</Info>
