...
slug: api-reference/concurrency-limits-and-timeouts
---
...
<AccordionGroup>
  <Accordion title="Conversational use cases">
    ...
    For real-time conversational use cases, such as powering voice agents, the number of parallel conversations you can support is effectively 4X your concurrency limit.
