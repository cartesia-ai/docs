...
<Note>
You don't need to understand embeddings to use Voice Mixing, which is available in the [playground](https://play.cartesia.ai) and the [API](/2024-11-13/api-reference/voices/mix).
</Note>
