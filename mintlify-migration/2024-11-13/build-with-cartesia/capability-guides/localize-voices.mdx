...
description: Learn how to localize voices for your brand or product.
icon: earth-americas
---
Localization is available in the [playground](https://play.cartesia.ai) and the [API](/2024-11-13/api-reference/voices/localize).
