...
---
<Note>
The tips below are specific to current our [Sonic model family](/2024-11-13/build-with-cartesia/models), and may change in the future as we improve our modeling and training procedure.
</Note>
