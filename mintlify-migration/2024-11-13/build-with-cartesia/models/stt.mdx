...
To learn how to use the Ink STT family, see [the Speech-to-Text API Reference](/2024-11-13/api-reference/stt/stt). You can find a detailed mapping of codes to languages, see the [STT supported languages](/2024-11-13/api-reference/stt/stt#request.query.language) list.
