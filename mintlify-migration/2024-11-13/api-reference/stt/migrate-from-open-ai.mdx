...
For real-time transcription, use our [Streaming STT endpoint](/2024-11-13/api-reference/stt/stt).
</Info>
...
For the complete parameter reference, see our [Batch STT API documentation](/2024-11-13/api-reference/stt/transcribe).
