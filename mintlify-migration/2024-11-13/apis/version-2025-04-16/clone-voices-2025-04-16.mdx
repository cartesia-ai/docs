...
Voice cloning is available through the [playground](https://play.cartesia.ai) and the [API](/2024-11-13/api-reference/voices/clone). High-similarity clones sound more like the source clip, but may reproduce background noise.
