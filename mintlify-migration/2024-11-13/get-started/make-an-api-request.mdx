...
description: Generate your first words and learn API conventions
icon: paper-plane
---
## Prerequisites
...
This command calls the [Text to Speech (Bytes)](/2024-11-13/api-reference/tts/bytes) endpoint which runs the text-to-speech generation and transmits the output in raw bytes.
