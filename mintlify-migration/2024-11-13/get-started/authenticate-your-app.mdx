...
For detailed API specifications, see the [Token API Reference](/2024-11-13/api-reference/auth/access-token).
...
- [API Reference](/2024-11-13/api-reference/auth/access-token) - Access Token generation endpoint documentation
