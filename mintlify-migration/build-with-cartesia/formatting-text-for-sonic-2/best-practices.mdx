...
---
<Note>
The tips below are specific to current our [Sonic model family](/build-with-cartesia/tts-models), and may change in the future as we improve our modeling and training procedure.
</Note>
