---
slug: use-the-api/api-conventions
---
<Warning>
...
Authentication is handled using API keys. You can create a new API key from [play.cartesia.ai/keys](https://play.cartesia.ai/keys). To use your API key, include `Authorization: Bearer <api_key>` in the HTTP headers of Cartesia API requests.
...
Read the full documentation for this at [Access Token API Reference](/2024-06-10/api-reference/auth/access-token) for more info.
