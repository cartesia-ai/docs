...
This command calls the [Text to Speech (Bytes)](/2024-06-10/api-reference/tts/bytes) endpoint which runs the text-to-speech generation and transmits the output in raw bytes.
