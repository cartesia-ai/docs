...
description: Learn how Sonic uses embeddings to represent voices and enable voice
  mixing.
icon: waveform
---
<Note>
You don't need to understand embeddings to use Voice Mixing, which is available in the [playground](https://play.cartesia.ai) and the [API](/2024-06-10/api-reference/voices/mix).
</Note>
