...
description: Tips and tricks for better generation quality with Sonic-2
icon: font
---
<Note>
The tips below are specific to current our [Sonic model family](/2024-06-10/build-with-cartesia/models), and may change in the future as we improve our modeling and training procedure.
</Note>
