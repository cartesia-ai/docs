...
<Info>
This guide will cover how input streaming works from the perspective of the Sonic-2 model. If you just want to implement input streaming, see [the WebSocket API reference](/2024-06-10/api-reference/tts/tts), which implements continuations using _contexts_.
</Info>
