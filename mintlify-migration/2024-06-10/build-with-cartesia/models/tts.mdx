...
- [Infill](/2024-06-10/api-reference/infill/bytes) support

| Snapshot                                                  | Release Date   | Languages                                                  | Status |
| --------------------------------------------------------- | -------------- | ---------------------------------------------------------- | ------ |
| <Icon icon="circle" size="10px" iconType="solid" color="#008000"/> `sonic-2-2025-06-11` | June 11, 2025  | en, fr, de, es, pt, zh, ja, hi, it, ko, nl, pl, ru, sv, tr | Stable |
| `sonic-2-2025-05-08` | May 8, 2025    | en, fr, de, es, pt, zh, ja, hi, it, ko, nl, pl, ru, sv, tr | Stable |
...
To learn how to use the Sonic TTS family, see [Make an API request](/2024-06-10/get-started/make-an-api-request).
...
| Snapshot                                                      | Release Date  | Languages                                                  | Status |
| ------------------------------------------------------------- | ------------- | ---------------------------------------------------------- | ------ |
| <Icon icon="circle" size="10px" iconType="solid" color="#008000"/> `sonic-turbo-2025-03-07` | March 7, 2025 | en, fr, de, es, pt, zh, ja, hi, it, ko, nl, pl, ru, sv, tr | Stable |
...
| Snapshot                                                | Release Date      | Languages                                                  | Status |
| ------------------------------------------------------- | ----------------- | ---------------------------------------------------------- | ------ |
| <Icon icon="circle" size="10px" iconType="solid" color="#008000"/> `sonic-2024-12-12` | December 12, 2024 | en, fr, de, es, pt, zh, ja, hi, it, ko, nl, pl, ru, sv, tr | Stable |
