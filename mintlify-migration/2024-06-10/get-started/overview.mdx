...
description: Our API enables developers to build real-time, multimodal AI experiences
...
Learn more about available Sonic model variants and their capabilities in the [TTS Models](/2024-06-10/build-with-cartesia/models/tts) section.
...
Learn more about the Ink model and its capabilities in the [STT Models](/2024-06-10/build-with-cartesia/models/stt) section.
