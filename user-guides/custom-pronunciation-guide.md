...
When using Sonic (whether through the playground, API, or client library) you can directly add Sonic-flavored IPA phones in the transcript. Just wrap them in `<<>>` and separate each phoneme with a pipe `|`.
