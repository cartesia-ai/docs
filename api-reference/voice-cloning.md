---
description: Capture a voice from an audio clip
---
...
{% swagger src="../.gitbook/assets/openapi (2).yml" path="/voices/clone/clip" method="post" %}
[openapi (2).yml](<../.gitbook/assets/openapi (2).yml>)
{% endswagger %}

{% swagger src="../.gitbook/assets/openapi (2).yml" path="/voices/clone/url" method="post" %}
[openapi (2).yml](<../.gitbook/assets/openapi (2).yml>)
{% endswagger %}
